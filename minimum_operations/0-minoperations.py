...
"""
    Calcule le nombre minimal d'opérations de copie et de collage pour décomposer
    un nombre entier positif n en utilisant ses facteurs premiers, et affiche chaque
    opération effectuée.
"""
